...
-- Cart table (stores shopping cart items per account)
...
-- Query 4 (from assignment2.sql query d): Update GM Hummer's description
...
-- Query 6 (from assignment2.sql query f): Update inventory image paths by adding '/vehicles'
UPDATE public.inventory
