...
ALTER TYPE public.account_type OWNER TO cse340br;
...
-- Update inventory image paths to include /vehicles directory
UPDATE public.inventory
SET inv_image = REPLACE(inv_image, '/images/', '/images/vehicles/'),
  inv_thumbnail = REPLACE(inv_thumbnail, '/images/', '/images/vehicles/');

-- Cart table: stores items a logged-in user has added to their cart
...
-- Note: existing session-based cart is unchanged. Migrate session data to DB via app logic if desired later.